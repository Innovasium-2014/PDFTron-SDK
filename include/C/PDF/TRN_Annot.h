...
TRN_API	TRN_AnnotBorderStyleCreateWithDashPattern(enum TRN_AnnotBorderStyleStyle s, double b_width, double b_hr, double b_vr, double* buffer, int buf_length, TRN_AnnotBorderStyle* result);
