...
TRN_API TRN_ConvertFileToXod (TRN_UString in_inputFilename, TRN_UString in_outputFilename, TRN_Obj options);
TRN_API TRN_ConvertToXod (TRN_PDFDoc in_pdfdoc, TRN_UString in_outputFilename, TRN_Obj options);
...
TRN_API TRN_ConvertFileToTiff (TRN_UString in_inputFilename, TRN_UString in_outputFilename, TRN_Obj options);
TRN_API TRN_ConvertToTiff (TRN_PDFDoc in_pdfdoc, TRN_UString in_outputFilename, TRN_Obj options);
#ifdef __cplusplus
}
#endif
